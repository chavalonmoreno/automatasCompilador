...
//    
    public static void main(String[] args) {
        ...
        Programax p = new Programax(new Declarax(new Typex("int"),"xxxx"),
                new Ifx(new Comparax(new Idx("a"), new Idx("b")), new Asignax(new Idx("c"), new Idx("d")),
                new Asignax(new Idx("e"), new Idx("f"))));
        
        
        Declarax d = VisitaArbol(px);
        System.out.println(d.s2);
        Statx d2 = VisitaArbol2(px);
